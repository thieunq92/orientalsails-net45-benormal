...
namespace CMS.ServerControls.FileUpload
{
    public partial class FileUploaderAJAX : CompositeControl
    {
        ...
        private string creaDivs()
        {
            ...
            <a href=""javascript:void(0)"" onclick=""{0}add('{2}', '{3}')"" id=""{0}Add"">{1}</a>
                ...
                clave, text_Add, (int) FileUploaderAJAX.clave1Values.sNormal, (int) FileUploaderAJAX.clave1Values.sRecuperar);
        ...
        private string loadJS()
        {
            ...
            if (Page.IsPostBack)
                sb.AppendFormat("setTimeout('load_{0}()', 200);", (object) clave);
            else
        ...
        private string loadJSCore()
        {
            ...
            sb.AppendFormat(
                ...
                {{
                    ...
                    if ({4})
                        {0}add('{1}', '{2}');
                    ",
                clave, (int) FileUploaderAJAX.clave1Values.sNormal, (int) FileUploaderAJAX.clave1Values.sRecuperar, takeCustomJS(FileUploaderAJAX.customJSevent.preLoad),
            ...
            if (History != null)
                foreach (HttpPostedFileAJAX pf in History)
                {
                    if (!pf.Deleted || showDeletedFilesOnPostBack)
                        sb.AppendFormat("{2}add('{0}', '{1}');", (int) FileUploaderAJAX.clave1Values.sRecuperar, pf.FileName_SavedAs,
                                        clave);
                }
            ...
            ",
                ...
                (int) FileUploaderAJAX.clave1Values.sRecuperar
                , takeCustomJS(FileUploaderAJAX.customJSevent.preAdd)
                , takeCustomJS(FileUploaderAJAX.customJSevent.postAdd)
                , takeCustomJS(FileUploaderAJAX.customJSevent.postLoad));
        ...
        private void normal()
        {
            ...
            {7}           
                ...
                , clave1, clave2, clave2Value, (int) FileUploaderAJAX.clave1Values.sUploading, clave, ClavePrincipal, action,
                ocultarDiv()
                , takeCustomJS(FileUploaderAJAX.customJSevent.preUpload));
        ...
        private string uploadedAux(HttpPostedFileAJAX _MyPostedFile)
        {
            ...
            if (_MyPostedFile.Saved)
            {
                ...
                sb.AppendFormat(" <input type=\"hidden\" id=\"{0}\">", (object) clave);
            }
            else
            {
            ...
            sb.AppendFormat(
                ...
                , clave1, clave2, clave3, (int) FileUploaderAJAX.clave1Values.sEliminar, clave2Value, _MyPostedFile.FileName_SavedAs,
                clave, ClavePrincipal, action, ocultarDiv()
                , takeCustomJS(FileUploaderAJAX.customJSevent.preDelete), takeCustomJS(FileUploaderAJAX.customJSevent.postUpload)
        ...
        private string RemoveAux(int historyIndex)
        {
            ...
            sb.AppendFormat(
                ...
                , ocultarDiv(), takeCustomJS(FileUploaderAJAX.customJSevent.postDelete));
        ...
        ",
                clave,
                takeCustomJS(FileUploaderAJAX.customJSevent.preHide),
                takeCustomJS(FileUploaderAJAX.customJSevent.postHide),
    ...
    ",
            ...
            if (addCall)
                sb.AppendFormat("{0}assureMaxFilesLimit();", (object) clave);
