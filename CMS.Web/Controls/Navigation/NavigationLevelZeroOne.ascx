<%@ Control Language="c#" AutoEventWireup="false" Codebehind="NavigationLevelZeroOne.ascx.cs" Inherits="CMS.Web.Templates.Controls.NavigationLevelZeroOne" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<div id="mainmenuarea">
	<ul id="mainmenu">
