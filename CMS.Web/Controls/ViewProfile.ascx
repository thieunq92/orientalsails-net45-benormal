<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ViewProfile.ascx.cs" Inherits="CMS.Web.Controls.ViewProfile" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
