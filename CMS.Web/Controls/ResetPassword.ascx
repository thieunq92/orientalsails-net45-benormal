<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ResetPassword.ascx.cs" Inherits="CMS.Web.Controls.ResetPassword" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
