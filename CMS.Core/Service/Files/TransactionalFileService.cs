    ...
    public class TransactionalFileService : IFileService
    {
        ...
        public void WriteFile(string filePath, Stream fileContents)
        {
            ...
            if (transaction != null)
            {
                ...
                FileWriter fileWriter = new FileWriter(_tempDir);
        ...
        public bool CheckIfDirectoryIsWritable(string physicalDirectory)
        {
            ...
            {
                log.Error(
                    String.Format("An unexpected error occured while checking write access for the directory {0}.",
                                  physicalDirectory), ex);
                throw;
            }
        }
        ...
        {
            ITransactionManager transactionManager = _kernel[typeof (ITransactionManager)] as ITransactionManager;
