...
namespace CMS.Core.Util
{
    ...
    public class Globalization
    {
        ...
        /// <param name="culture"></param>
        /// <returns></returns>
        public static string GetDisplayLanguageTextFromCulture(string culture)
        {
            CultureInfo ci = new CultureInfo(culture);
            string languageAsText = ci.DisplayName.Substring(0, ci.DisplayName.IndexOf("(") - 1);
        ...
        /// </summary>
        /// <returns></returns>
        public static SortedList GetOrderedLanguages()
        {
            SortedList orderedCultures = new SortedList();
